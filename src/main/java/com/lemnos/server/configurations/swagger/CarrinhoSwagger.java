...
public interface CarrinhoSwagger extends SwaggerConfiguration{
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Fetched the cart successfully", content = @Content(schema = @Schema(implementation = CarrinhoResponse.class))),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Fetched the quantity successfully", content = @Content(schema = @Schema(implementation = Integer.class))),
            @ApiResponse(responseCode = "401", description = "Unauthorized, you are not authenticated", content = @Content(schema = @Schema())),
            @ApiResponse(responseCode = "403", description = "Forbidden, you don't have the role to fetch the cart", content = @Content(schema = @Schema())),
            @ApiResponse(responseCode = "404", description = "Not Found, User not found", content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not Found, User, Cart or item not found", content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    })
    @SecurityRequirement(name = "Authorization")
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Not Found, User or Cart not found", content = @Content(schema = @Schema(implementation = ExceptionResponse.class)))
    })
    @SecurityRequirement(name = "Authorization")
