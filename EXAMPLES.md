...
###### Alguma Dúvida sobre o corpo de um erro? [Erros](https://github.com/LucasBonato/Lemnos-Server?tab=readme-ov-file#Erros)

---

### Login

Quando logado a API irá retornar um token para ser utlizado posteriormente no [Header](https://github.com/LucasBonato/Lemnos-Server?tab=readme-ov-file#Headers) Authorization.
